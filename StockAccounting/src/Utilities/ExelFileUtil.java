...
public class ExelFileUtil
{
	...
	{
		FileInputStream fin=new FileInputStream("C:\\Users\\megha.m\\ERP_Project\\AutomationTesting\\StockAccounting\\TestInputs\\InputSheet1.xlsx");
	...
	public void setData(String sheetname,int row,int col,String Result) throws IOException
	{
		...
		FileOutputStream fout=new FileOutputStream("C:\\Users\\megha.m\\ERP_Project\\AutomationTesting\\StockAccounting\\TestOutputs\\OutputSheet1.xlsx");
		wb.write(fout);
		fout.close();
