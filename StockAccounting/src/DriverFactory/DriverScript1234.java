...
public void startTest() throws Throwable
{
	...
	for (int i = 1;i<=excel.rowCount("MasterTestCases");i++)
	{
		...
		if(excel.getData("MasterTestCases", i, 2).equalsIgnoreCase("Y"))
		{
			...
			report=new ExtentReports("C:\\Users\\megha.m\\ERP_Project\\AutomationTesting\\StockAccounting\\Report\\"+TCModule+FunctionLibrary.generateDate()+".html");
...
FileUtils.copyFile(srcFile, new File("C:\\Users\\megha.m\\ERP_Project\\AutomationTesting\\StockAccounting\\ScreenShots\\"+TCModule+"  "+FunctionLibrary.generateDate()+".png"));
					break;
				}
			}
